...
The Nextcloud WHMCS module is a provisioning module that integrates WHMCS with Nextcloud servers, enabling cloud service providers to offer Nextcloud-based accounts to their customers. The module automates the full lifecycle of user account management through API integration with Nextcloud.

---

## Main features

- **Automatic account provisioning** — auto create and deploy client Nextcloud accounts upon order activation
- **Account lifecycle management** — create, suspend, unsuspend, terminate, change password, and change package (upgrade/downgrade) for Nextcloud user accounts
...
- **Group management** — assign Nextcloud groups to users on the server side, automatic group creation
...
- **Product page:** [https://puqcloud.com/whmcs-module-nextcloud.php](https://puqcloud.com/whmcs-module-nextcloud.php)
- **Documentation:** [https://doc.puq.info/books/nextcloud-whmcs-module](https://doc.puq.info/books/nextcloud-whmcs-module)
